local NormSpatialConvolution, parent = torch.class('nn.NormSpatialConvolution', 'nn.Module')

function NormSpatialConvolution:__init(nInputPlane, nOutputPlane, kW, kH, dW, dH, padding)
   parent.__init(self)
...
function NormSpatialConvolution:reset(stdv)
   if stdv then
